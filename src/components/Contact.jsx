const socialLinks = [
    {
        href: 'https://github.com/kengserch',
        icon: (
    ...
    {
        href: 'https://www.linkedin.com/in/prasert-saengkaew-3b4885241/',
        icon: (
            <svg width="35" height="35" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    {
        href: 'https://www.facebook.com/prasert.sangkaew.18/',
        icon: (
            <svg width="35" height="35" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    fillRule="evenodd"
    ...
    {
        href: 'https://www.instagram.com/kengserch/',
        icon: (
